...
import {
  ...
  pickUrl,
  renderXYZTemplate
} from "./chunk-5C4VPL6K.js";
import {
  TileCache_default
} from "./chunk-Z7456VJ4.js";
import {
  Source_default
} from "./chunk-3E5QXSGZ.js";
import {
  DataTile_default,
  DataTile_default2,
  Tile_default as Tile_default3
} from "./chunk-K5HGQLA2.js";
...
var VectorTile = class extends UrlTile_default {
  ...
  constructor(options) {
    ...
    this.sourceTileCache_ = new TileCache_default(128);
  ...
  getSourceTiles(pixelRatio, projection, tile) {
    if (tile.getState() === TileState_default.IDLE) {
      ...
      sourceTileGrid.forEachTileCoord(extent, sourceZ, (sourceTileCoord) => {
        ...
        const sourceTile = this.sourceTileCache_.containsKey(tileUrl2) ? this.sourceTileCache_.get(tileUrl2) : new this.tileClass(
          sourceTileCoord,
        ...
        if (sourceTileState === TileState_default.IDLE) {
          ...
          this.sourceTileCache_.set(tileUrl2, sourceTile);
          sourceTile.load();
        }
      });
